...
//$STYLE['sb_th_bgcolor'] = ""; // ("#fff") subject テーブルヘッダ背景色
//$STYLE['sb_th_background'] = ""; // ("./skin/live/bg.gif") subject テーブルヘッダ背景画像
//$STYLE['sb_tbgcolor'] = ""; // ("#fff") subject テーブル内背景色0
//$STYLE['sb_tbgcolor1'] = ""; // ("#fff") subject テーブル内背景色1
...
//新着レス
$MYSTYLE['subject']['sb_td']['border-bottom'] = "1px dotted #ccc"; // ("1px dotted #999") subject テーブルのボーダー0
$MYSTYLE['subject']['sb_td1']['border-bottom'] = "1px dotted #ccc"; // ("1px dotted #999") subject テーブルのボーダー1
