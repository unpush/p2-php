...
/* subject ========================================================== */
$_conf['refresh_time'] = 20;	// (20) スレッド一覧の自動更新間隔。（分指定。0なら自動更新しない。）
$_conf['sb_show_motothre'] = 1;	// (1) スレッド一覧で未取得スレに対して元スレへのリンク（・）を表示 (する:1, しない:0)
$_conf['sb_show_one'] = 1;	// (0) スレッド一覧（板表示）で>>1を表示 (する:1, しない:0, ニュース系のみ:2)
...
$_conf['ext_win_target'] = "";	// ("") 外部サイト等へジャンプする時に開くウィンドウのターゲット名（同窓:"", 新窓:"_blank"）
...
$_conf['k_rnum_range'] = 20;	// (20) 携帯閲覧時、一度に表示するレスの数
$_conf['ktai_res_size'] = 500; 		// (500) 携帯用、一つのレスの最大表示サイズ
...
$_conf['join_favrank'] = 1;	// (1) お気にスレ共有に参加（する:1, しない:0）
