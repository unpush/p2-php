...
echo <<<EOP
<div><b>{$ptitle_hd}の編集</b> [<a href="{$_SERVER['PHP_SELF']}" onclick='parent.menu.location.href="{$_conf['menu_php']}?nr=1"'>メニューを更新</a>] {$switch_rss_form_ht}</div>\n
EOP;
...
if ($lines) {
	...
	foreach ($lines as $l) {
		...
		if (count($p) > 1) {
			...
			echo <<<EOP
	<tr>
		<td><a href="{$_SERVER['PHP_SELF']}?xml={$xml_en}&amp;setrss=0" class="fav">★</a></td>
		<td><a href="{$_conf['subject_rss_php']}?xml={$xml_en}{$site_ht}{$atom_ht}">{$site}</a></td>
		<td>(<a class="te" href="{$_SERVER['PHP_SELF']}?xml={$xml_en}{$site_ht}{$cngtype_ht}">{$type_ht}</a>)</td>
		<td>[ <a class="te" href="{$_SERVER['PHP_SELF']}?xml={$xml_en}{$site_ht}{$atom_ht}&amp;setrss=top">▲</a></td>
		<td><a class="te" href="{$_SERVER['PHP_SELF']}?xml={$xml_en}{$site_ht}{$atom_ht}&amp;setrss=up">↑</a></td>
		<td><a class="te" href="{$_SERVER['PHP_SELF']}?xml={$xml_en}{$site_ht}{$atom_ht}&amp;setrss=down">↓</a></td>
		<td><a class="te" href="{$_SERVER['PHP_SELF']}?xml={$xml_en}{$site_ht}{$atom_ht}&amp;setrss=bottom">▼</a> ]</td>
	</tr>\n
EOP;
		}
	}
