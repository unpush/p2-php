...
// YourFileHost動画のURLにダウンロード用リンクを付加 (する:1, しない:0)
$conf_user_def['link_yourfilehost'] = 0; // (0)
$conf_user_sel['link_yourfilehost'] = array('1' => 'する', '0' => 'しない');

// 2chのBEアイコンを表示 (する, しない)
$conf_user_def['show_be_icon'] = 1; // (1)
$conf_user_sel['show_be_icon'] = array('1' => 'する', '0' => 'しない', '2' => 'PCのみ', '3' => '携帯のみ');
...
// 携帯閲覧時、元スレURLのカスタマイズ指定
// http://c.2ch.net/test/-33!&mail={$mail}&FROM={$FROM}/{$bbs}/{$key}/{$ls}
$conf_user_def['k_motothre_template'] = 'http://c.2ch.net/test/-33!&mail={$mail}&FROM={$FROM}/{$bbs}/{$key}/{$ls}';
$conf_user_rules['k_motothre_template'] = array('emptyToDef');

// 携帯閲覧時、元スレURLのカスタマイズ指定を外部板でも有効にする
$conf_user_def['k_motothre_external'] = 0; // (0)
$conf_user_sel['k_motothre_external'] = array('1' => 'する', '0' => 'しない');
...
// 携帯閲覧時、書き込みフォームの桁数
$conf_user_def['k_post_msg_cols'] = '';   // ('')
$conf_user_rules['k_post_msg_cols'] = array('emptyToDef', 'notIntExceptMinusToDef');
