...
<a id="smy{$new_matome_i}" class="matome" href="{$_conf['read_new_php']}?host={$aThreadList->host}&amp;bbs={$aThreadList->bbs}&amp;spmode={$aThreadList->spmode}{$norefresh_q}&amp;nt={$newtime}" onclick="rep2.subject.changeNewAllColor();">新着まとめ読み{$shinchaku_num_ht}</a>
EOP;
} else {
    $shinchaku_matome_ht = '';
}
