...
class P2Util{
    ...
    function subjectDownload($in_url, $subjectfile)
    {
        ...
        if ($wap_res->is_success() && $wap_res->code != "304") {
            ...
            // したらばならEUCをSJISに変換
            if (strstr($subjectfile, $_conf['dat_dir']."/jbbs.shitaraba.com") || strstr($subjectfile, $_conf['dat_dir']."/jbbs.livedoor.com") || strstr($subjectfile, $_conf['dat_dir']."/jbbs.livedoor.jp")) {
